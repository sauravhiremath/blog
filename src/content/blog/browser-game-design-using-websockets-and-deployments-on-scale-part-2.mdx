...
![Game Architecture (from the previous article)](https://miro.medium.com/v2/format:webp/1*QEqiWlUQaaJ1DsjEUhN4dA.png)
...
### Client Side
![Room creation page](https://dev-to-uploads.s3.amazonaws.com/i/sst8zicg480mbbo3w88w.png)
...
![Pre-game Lobby](https://dev-to-uploads.s3.amazonaws.com/i/h96n1ki8yxotxfvddp9b.png)
...
![Add your GitHub URL and click to deploy](https://dev-to-uploads.s3.amazonaws.com/i/6oi729imfav7b1xi920k.png)
...
> 
> ![reverse-proxy-flow](https://dev-to-uploads.s3.amazonaws.com/i/8vo5u7nyvhy1yrg1r7gb.png)
...
![Network Balancing Overview](https://dev-to-uploads.s3.amazonaws.com/i/efa3iatf1ntsq6mb2er4.png)
...
![My pm2 monitoring on server](https://dev-to-uploads.s3.amazonaws.com/i/cdnox8319gdtyjms26sz.png)
